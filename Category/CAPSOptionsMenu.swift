...
open class CAPSOptionsMenu: UIView, UIGestureRecognizerDelegate
{
    ...
    open func customizeWith(maxMenuWidth: CGFloat?, shadow: Bool?, shadowColor: UIColor?, backgroundColor: UIColor?, borderWidth: CGFloat?, borderColor: UIColor?, actionButtonsTitleColor: UIColor?, actionButtonsHighlightedColor: UIColor?, cornerRadius: CGFloat?, animationOption: AnimationOption?, animationDuration: TimeInterval?) {
        if let mMenuWidth = maxMenuWidth
        {
            self.maxMenuWidth = mMenuWidth
        }
        ...
        if let shColor = shadowColor
        {
            menuShadowColor = shColor
        }
        ...
        {
            menuBorderWidth = bWidth
        }
        
        if let bColor = borderColor
        {
            menuBorderColor = bColor
        }
        
        if let aBTColor = actionButtonsTitleColor
        {
            menuActionButtonsTitleColor = aBTColor
        }
        
        if let aBHColor = actionButtonsHighlightedColor
        {
            menuActionButtonsHiglightedColor = aBHColor
        }
        
        if let cRadius = cornerRadius
        {
            menuCornerRadius = cRadius
        }
        
        if let aOption = animationOption
        {
            menuAnimationOption = aOption
        }
        
        if let aDuration = animationDuration
        {
            menuAnimationDuration = aDuration
        }
